...
# ══════════════════════════════════════════════════════════════════
# HOME STATE — đếm động từ file JSON
# ══════════════════════════════════════════════════════════════════
...
class HomeState(rx.State):
    ...
    def load_counts(self):
        """Đọc số học phần và số lớp học từ file JSON."""
        try:
...
def _stat_card(icon: str, icon_color: str, label: str, value, on_click=None):
    ...
    return rx.box(
        rx.vstack(
            ...
            rx.text(label, font_size="0.8rem", color=T.TEXT_SECONDARY, font_weight="500"),
            rx.text(value, font_size="1.5rem", font_weight="800", color=T.TEXT_PRIMARY),
            spacing="2",
            align="center",
        ),
        bg=T.SURFACE,
